...
class CloudPresentDecoder implements GroupDecoderInterface
{
    ...
    private $formLowCloudMap = [
        ...
        '2' => 'Cumulus moderate or string vertical extent, generally with protuberances in the form of domes or towers either accompanied or not by other Cumulus or by Stratocumulus, all having their bases at the same level',
        '3' => 'Cumulonimbus the summits of switch, at least partially, lack sharp outlines, but are neither clearly fibrous (cirriform) nor in the form of an anvil; Cumulus, Stratocumulus or Status may also be present',
    ...
    private $formMediumCloudMap = [
        ...
        '1' => 'Altostratus, the greater part of which is semi-transparent; trough this part the sun or moon may be weakly visible as trough ground glass',
        ...
        '7' => 'Altocumulus in two or more layers, usually opaque in places, and not progressively invading the sky; or opaque layer of Altocumulus not progressivelly invading the sky; or Altocumulus together with Altostratus or Nimbostratus',
        ...
        '/' => 'Altocumulus, Altostarus and Nimbostratus invisible owing to darkness, fog, blowing dust or sand, or other similar phenomena, or more often because of the presence of a continuous layer of lower clouds',
    ];
    ...
    private $formHighCloudMap = [
        ...
        '4' => 'Cirrus in the forms of hooks or of filaments, or both, progressively invading the sky; they generally become denser as a whole',
        '5' => 'Cirrus (often in band converging toward one point or two opposite points of the horizon) and Cirrostratus, or Cirrostrarus alone; in either case, they are progressively invading the sky, and generally growing denser as a whole, but the continuous veil does not reach 45 degrees above the horizon',
        '6' => 'Cirrus (often in band converging toward one point or two opposite points of the horizon) and Cirrostratus, or Cirrostrarus alone; in either case, they are progressively invading the sky, and generally growing denser as a whole; the continuous veil extends more than 45 degrees above the horizon, without the sky being totally covered',
